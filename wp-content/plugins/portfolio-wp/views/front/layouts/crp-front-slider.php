...
<link href="<?php echo CRP_CSS_URL.'/owl-carousel/assets/owl.carousel.min.css'; ?>" rel="stylesheet" type="text/css" />
<link href="<?php echo CRP_CSS_URL.'/owl-carousel/layout.css'; ?>" rel="stylesheet" type="text/css" />
<!--Link JS Files-->
<script src="<?php echo CRP_JS_URL.'/owl-carousel/owl.carousel.js'; ?>"></script>
